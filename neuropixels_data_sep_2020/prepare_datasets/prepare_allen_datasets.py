...
def prepare_allen_datasets():
    ...
    upload_file_to_compute_resource(times1_npy_uri)
    upload_file_to_compute_resource(labels1_npy_uri)
    upload_file_to_compute_resource(unit_channels1_npy_uri)
    ...
    upload_file_to_compute_resource(times2_npy_uri)
    upload_file_to_compute_resource(labels2_npy_uri)
    upload_file_to_compute_resource(unit_channels2_npy_uri)
